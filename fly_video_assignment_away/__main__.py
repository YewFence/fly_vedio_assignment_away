...
from fly_video_assignment_away.cli.setup_wizard import ensure_env_configured

ensure_env_configured()

# 2. 引导完成后才导入 config
from fly_video_assignment_away import config
from fly_video_assignment_away.automation import AuthManager, BrowserManager, VideoManager
from fly_video_assignment_away.automation.exception_context import BrowserClosedError
from fly_video_assignment_away.cli.cookie_fix import cookie_fix
from fly_video_assignment_away.logger import get_logger, setup_logging
